  ...
  describe 'push to ORCID', :order => :defined do
    ...
    describe 'get' do
      it 'should get notification' do
        ...
        expect(notification["put_code"]).to eq("144942")
        expect(notification["items"]["item"]).to eq("item_type"=>"work", "item_name"=>"1000 random PLOS ONE DOIs from 2013", "external_id"=>{"external_id_type"=>"DOI", "external_id_value"=>"10.6084/M9.FIGSHARE.1066168"})
